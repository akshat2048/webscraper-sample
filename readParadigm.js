...
class Parser {
    ...
    // Retrieves a list of tabroom entries for a given tournament
    getTabroomEntriesList = async (URL) => {
    ...
    // Retrieves a list of judging paradigms for a given tournament
    
}

export async function readParadigm(URL, tourneyName) {
    const judges = []
    const getRawData = function(URL) {
        return fetch(URL)
        .then((response) => response.text())
        .then((data) => {
            return data;
